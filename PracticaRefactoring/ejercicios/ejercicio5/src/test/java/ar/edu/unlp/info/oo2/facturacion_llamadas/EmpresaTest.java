...
class EmpresaTest {
	...
	void testcalcularMontoTotalLlamadas() {
		Cliente emisorPersonaFisca = sistema.registrarUsuario("11555666", "Brendan Eich" , new TipoFisica());
		Cliente remitentePersonaFisica = sistema.registrarUsuario("00000001", "Doug Lea" , new TipoFisica());
		Cliente emisorPersonaJuridica = sistema.registrarUsuario("17555222", "Nvidia Corp" , new TipoJuridica());
		Cliente remitentePersonaJuridica = sistema.registrarUsuario("25765432", "Sun Microsystems" , new TipoJuridica());
	...
	void testAgregarUsuario() {
		...
		this.sistema.agregarNumeroTelefono("2214444558"); 
		Cliente nuevaPersona = this.sistema.registrarUsuario("2444555","Alan Turing", new TipoFisica());
